...
class ProgressAdmin(admin.ModelAdmin):
    ...
    'inmental_A_sum','inmental_B_sum','inmental_C_sum','incase_A_sum','incase_B_sum','incase_C_sum')
...
class CTRSAdmin(admin.ModelAdmin):
    ...
    list_display = ('id','CT','danger_date','last_date','danger_label','counselor','sum_1','sum_2','sum_3','sum_4','total')
    list_display_links = ('CT',)
