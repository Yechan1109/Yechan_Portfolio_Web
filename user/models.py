...
class Program(models.Model):
    program_name = (
        ('교육지원사업', (
            ('성매매예방교육연극(중학교)', '성매매예방교육연극(중학교)'),
            ('기관 실무자교육', '기관 실무자교육'),
            ('성교육장이용','성교육장이용')
        )),
        ('사춘기클리닉', (
            ('사람유두종바이러스 예방접종 특화', '사람유두종바이러스 예방접종 특화'),
            ('찾아가는 성건강교육', '찾아가는 성건강교육'),
            ('성건강교육(1:1 / 소그룹)', '성건강교육(1:1 / 소그룹)'),
            ('생리대/기타여성용품/성건강수첩 배분','생리대/기타여성용품/성건강수첩 배분')
        )),
        ('네트워크', (
            ('홍보(전화/문자/홈피/SNS 등)', '홍보(전화/문자/홈피/SNS 등)'),
            ('네트워크 및 사업협력/후원발굴.관리', '네트워크 및 사업협력/후원발굴.관리'),
            ('직원교육/만족도조사/자원봉사 등', '직원교육/만족도조사/자원봉사 등')
        )),
        ('익명상담', (
            ('임신', '임신'),
            ('성건강', '성건강'),
    ...
    perfor_keyword = models.CharField(blank=True, default='', max_length=100, verbose_name='키워드')
